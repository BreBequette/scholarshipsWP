...
if ( ! class_exists( 'jb\admin\Enqueue' ) ) {
	...
	class Enqueue extends \jb\common\Enqueue {
		...
		function admin_scripts() {
			wp_register_script( 'jb-global', $this->js_url['admin'] . 'global' . JB()->scrips_prefix . '.js', [ 'jquery', 'wp-util', 'wp-i18n', 'wp-hooks' ], jb_version, true );
			...
			wp_register_style( 'jb-forms', $this->css_url['admin'] . 'forms' . JB()->scrips_prefix . '.css', [ 'jb-common', 'jb-helptip', 'wp-color-picker', 'jquery-ui' ], jb_version );
