	...
	class Config {
		...
		function init_email_notifications() {
			$this->email_notifications = apply_filters( 'jb_email_notifications', [
				'job_submitted' => [
					'key'               => 'job_submitted',
					'title'             => __( 'Scholarship submitted', 'jobboardwp' ),
					'subject'           => __( 'New Scholarship Submission - {site_name}', 'jobboardwp' ),
					'description'       => __( 'Whether to send the admin an email when new scholarship is posted on website.', 'jobboardwp' ),
					'recipient'         => 'admin',
					'default_active'    => true,
				],
				'job_approved'  => [
					'key'               => 'job_approved',
					'title'             => __( 'Scholarship approved', 'jobboardwp' ),
					'subject'           => __( 'Scholarship is now live - {site_name}', 'jobboardwp' ),
					'description'       => __( 'Whether to send the scholarship\'s author an email when job is approved.', 'jobboardwp' ),
					'recipient'         => 'user',
					'default_active'    => true,
				],
				'job_edited'    => [
					'key'               => 'job_edited',
					'title'             => __( 'Scholarship has been edited', 'jobboardwp' ),
					'subject'           => __( 'A scholarship has been edited - {site_name}', 'jobboardwp' ),
					'description'       => __( 'Whether to send the admin an email when new scholarship is edited on website.', 'jobboardwp' ),
					'recipient'         => 'admin',
					'default_active'    => true,
				],
			] );
